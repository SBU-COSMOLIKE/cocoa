...
parameter = [u'As_1e9',u'tau',u'H0',u's8omegamp5',u'omegabh2',u'omegach2', u'w0pwa', u'w']
chaindir=r'.'
...
param_3d = None
g.triangle_plot(['EXAMPLE_MCMC2', 'EXAMPLE_MCMC7'],parameter,
...
legend_labels=['w0-wa Quint PL+PT', 'w0-wa Quint SO+WF'],legend_loc=(0.5,0.825),
imax_shaded=0)
g.export()