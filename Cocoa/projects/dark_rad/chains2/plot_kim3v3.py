...
samples.saveAsText(chaindir + '/.VM_PKIM3v3_TMP1')
# --------------------------------------------------------------------------------
...
samples.saveAsText(chaindir + '/.VM_PKIM3v3_TMP2')
# --------------------------------------------------------------------------------
...
samples.saveAsText(chaindir + '/.VM_PKIM3v3_TMP3')
...
param_3d = None
g.triangle_plot(['.VM_PKIM3v3_TMP1','.VM_PKIM3v3_TMP2','.VM_PKIM3v3_TMP3'],parameter,
...
legend_labels=[
  ...
  'Planck $\\ell < 1296$ + Pantheon + DESI, LINEAR SCF (MNU)', 
  'Planck $\\ell < 1296$ + Pantheon + DESI  (no z=0.5, 0.7) + BOSS (no z=0.3), LINEAR SCF (MNU)', 
],
