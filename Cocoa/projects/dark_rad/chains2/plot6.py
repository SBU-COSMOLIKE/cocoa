...
samples=loadMCSamples('./' + '.VM_P6_TMP1',settings=analysissettings2)
...
samples=loadMCSamples('./' + '.VM_P6_TMP2',settings=analysissettings2)
samples.addDerived(p.chi2__planck_2018_lowl.TT + 
  p.chi2__planck_2018_lowl.EE + p.chi2__planck_2018_highl_plik.TTTEEE, 
  name='chi2CMB',label='{\\chi^2_{\\mathrm{CMB}}}')
samples.addDerived(p.chi2__sn.pantheon, 
...
samples=loadMCSamples('./' + '.VM_P6_TMP3',settings=analysissettings2)
samples.addDerived(p.chi2__planck_2018_lowl.TT + 
  p.chi2__planck_2018_lowl.EE + p.chi2__planck_2018_highl_plik.TTTEEE, 
  name='chi2CMB',label='{\\chi^2_{\\mathrm{CMB}}}')
samples.addDerived(p.chi2__sn.pantheon, 
...
legend_labels=['Model 5 PL+PT','Model 3 PL+PT', 'LCDM PL+PT'],
