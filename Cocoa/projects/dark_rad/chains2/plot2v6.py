...
parameter = [u'H0',u'omegabh2',u'omegach2',u'Omega_m',u'Omega0_scf_ke',u'chi2bao',u'chi2CMB',
u'chi2sn']
chaindir=r'.'
...
p = samples.getParams()
samples.saveAsText('.VM_P2V6_TMP2')
samples=loadMCSamples('./' + '.VM_P2V6_TMP2',settings=analysissettings2)
