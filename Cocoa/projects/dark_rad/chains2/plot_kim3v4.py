...
samples.addDerived(p.chi2__sn.pantheonplus,name='chi2_sn2',label='{\\chi^2_{\\rm SN}}')
samples.addDerived(p.chi2__bao.desi_y1,name='chi2_bao',label='{\\chi^2_{\\rm BAO}}')
samples.saveAsText(chaindir + '/.VM_PKIM3v4_TMP1')
# --------------------------------------------------------------------------------
...
samples.saveAsText(chaindir + '/.VM_PKIM3v4_TMP2')
...
param_3d = None
g.triangle_plot(['.VM_PKIM3v4_TMP1','.VM_PKIM3v4_TMP2'],parameter,
