...
parameter = [u'omegam2', u'H0',u'scf_c',u'w_scf_0',u'w_scf_p3',u'w_scf_p7',u'w_scf_1',u'w_scf_2']
chaindir=r'./'

analysissettings={'smooth_scale_1D':0.45,'smooth_scale_2D':0.45,
'ignore_rows': u'0.3','range_confidence' : u'0.025'}
...
samples.saveAsText(chaindir + '/.VM_PKIM3v2_TMP1')
# --------------------------------------------------------------------------------
...
samples.addDerived(p.sigma8*np.sqrt(p.omegan+(p.omegach2+p.omegabh2)/(p.H0/100.)/(p.H0/100.))/0.5477225575,name='SS8',label='{S_8}')
samples.saveAsText(chaindir + '/.VM_PKIM3v2_TMP2')


#GET DIST PLOT SETUP
g=gplot.getSubplotPlotter(chain_dir=chaindir,
analysis_settings=analysissettings2,width_inch=10.0)
...
param_3d = None
g.triangle_plot(['.VM_PKIM3v2_TMP1','.VM_PKIM3v2_TMP2'],parameter,
