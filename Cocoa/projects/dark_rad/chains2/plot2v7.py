...
parameter = [u'H0',u'omegabh2',u'omegach2',u'Omega_m',u'Omega0_scf_ke']
chaindir=r'.'
...
p = samples.getParams()
samples.saveAsText('.VM_P2V7_TMP1')
...
samples.thin(factor = int(len(samples.weights)/20000))
p = samples.getParams()
samples.saveAsText('.VM_P2V7_TMP2')
...
param_3d = None
g.triangle_plot(['.VM_P2V7_TMP1', '.VM_P2V7_TMP2'],parameter,
