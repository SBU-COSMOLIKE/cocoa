...
parameter = [u'omegam2', u'H0', u'SS8',u'm_ncdm',u'n_s',u'As_1e9',u'sigma8',u'scf_c',u'Omega0_scf_ke',u'chi2_sn2',u'chi2_cmb2']
chaindir=r'./'
...
samples.saveAsText(chaindir + '/.VM_PKIM2_TMP1')
# --------------------------------------------------------------------------------
...
samples.addDerived(p.chi2__planck_2018_lowl.TT+p.chi2__planck_2018_lowl.EE+p.chi2__planck_2018_highl_plik.TTTEEE,name='chi2_cmb2',label='{\\chi^2_{\\rm CMB}}')
samples.addDerived(p.chi2__sn.pantheon,name='chi2_sn2',label='{\\chi^2_{\\rm SN}}')
samples.saveAsText(chaindir + '/.VM_PKIM2_TMP2')
# --------------------------------------------------------------------------------
...
samples.addDerived(p.chi2__planck_2018_lowl.TT+p.chi2__planck_2018_lowl.EE+p.chi2__planck_2018_highl_plik.TTTEEE,name='chi2_cmb2',label='{\\chi^2_{\\rm CMB}}')
samples.addDerived(p.chi2__sn.pantheon,name='chi2_sn2',label='{\\chi^2_{\\rm SN}}')
samples.saveAsText(chaindir + '/.VM_PKIM2_TMP3')
# --------------------------------------------------------------------------------
...
param_3d = None
g.triangle_plot(['.VM_PKIM2_TMP1','.VM_PKIM2_TMP2','.VM_PKIM2_TMP3'],parameter,
...
legend_labels=[
  'Planck $\\ell < 1296$ + Pantheon, QUAD SCF (MNU)', 
  'Planck $\\ell < 1296$ + DESI + Pantheon, QUAD SCF (MNU)', 
  'Planck $\\ell < 1296$ + DESI + Pantheon (no z=0.5, 0.7) + BOSS (no z=0.3), QUAD SCF (MNU)', 
],
