...
root_chains = ('EXAMPLE_MCMC5','EXAMPLE_MCMC55','EXAMPLE_MCMC102')
...
p = samples.getParams()
samples.saveAsText('.VM_P6V3_TMP1')
samples=loadMCSamples('./' + '.VM_P6V3_TMP1',settings=analysissettings2)
...
legend_labels=['Model 5 PL+PT','Model 5 (Restricted) PL+PT', 'LCDM PL+PT'],
