...
parameter = [u'H0',u'Omega_m',u'omegach2', u'chi2bao',u'chi2CMB', u'chi2sn', u'chi2',u'chi2CMBlowell',u'chi2CMBhighell']
chaindir=r'.'

root_chains = ('EXAMPLE_MCMC4','EXAMPLE_MCMC13','EXAMPLE_MCMC102')
...
samples=loadMCSamples('./' + '.VM_P7_TMP1',settings=analysissettings2)
...
samples.addDerived(p.chi2__planck_2018_lowl.TT + 
  p.chi2__planck_2018_lowl.EE, 
  name='chi2CMBlowell',label='{\\chi^2_{\\mathrm{CMB-lowell}}}')
samples.addDerived( p.chi2__planck_2018_highl_plik.TTTEEE, 
  name='chi2CMBhighell',label='{\\chi^2_{\\mathrm{CMB-highell}}}')
...
samples=loadMCSamples('./' + '.VM_P7_TMP2',settings=analysissettings2)
samples.addDerived(p.chi2__planck_2018_lowl.TT + 
  p.chi2__planck_2018_lowl.EE + p.chi2__planck_2018_highl_plik.TTTEEE, 
  name='chi2CMB',label='{\\chi^2_{\\mathrm{CMB}}}')
samples.addDerived(p.chi2__sn.pantheon, 
...
samples=loadMCSamples('./' + '.VM_P7_TMP3',settings=analysissettings2)
samples.addDerived(p.chi2__planck_2018_lowl.TT + 
  p.chi2__planck_2018_lowl.EE + p.chi2__planck_2018_highl_plik.TTTEEE, 
  name='chi2CMB',label='{\\chi^2_{\\mathrm{CMB}}}')
samples.addDerived(p.chi2__sn.pantheon, 
...
#samples.addDerived(p.omegam, name='Omega_m',label='{\\Omega_{\\mathrm{m}}}')
oscf_min = 0.0
oscf_max = 2.0 #any reasonable number
samples.ranges.setRange('Omega0_scf_ke', [oscf_min, oscf_max])
samples.saveAsText('.VM_P7_TMP3')
...
#GET DIST PLOT SETUP
g=gplot.getSubplotPlotter(chain_dir=chaindir, analysis_settings=analysissettings2,width_inch=14.0)
...
param_3d = None
g.triangle_plot(['.VM_P7_TMP1','.VM_P7_TMP2','.VM_P7_TMP3'],parameter,
...
contour_colors=['royalblue','goldenrod','firebrick'],
contour_lws=[1.0,1.0,2.0],
filled=(True, True, False), shaded=False,
legend_labels=['Model 4 PL+PT','Model 3 PL+PT', 'LCDM PL+PT'],
