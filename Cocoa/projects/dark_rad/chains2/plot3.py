...
parameter = [u'As_1e9',u'tau',u'H0',u's8omegamp5',u'omegabh2',u'omegach2',u'Omega0_da_dr',
u'scf_friction',u'Omega0_scf_ke',u'chi2__BAO',u'chi2__CMB',u'chi2__SN']]
chaindir=r'.'

analysissettings={'smooth_scale_1D':0.45,'smooth_scale_2D':0.45,'ignore_rows': u'0.5','range_confidence' : u'0.025'}
...
param_3d = None
g.triangle_plot(['EXAMPLE_MCMC4', 'EXAMPLE_MCMC19'],parameter,
...
legend_labels=['Model 4 PL+PT', 'Model 4 SO+WF'],legend_loc=(0.5,0.825),
imax_shaded=0)
g.export()