...
samples.saveAsText(chaindir + '/.VM_PKIM4v3_TMP1')
# --------------------------------------------------------------------------------
...
samples.saveAsText(chaindir + '/.VM_PKIM4v3_TMP2')
...
param_3d = None
g.triangle_plot(['.VM_PKIM4v3_TMP1','.VM_PKIM4v3_TMP2'],parameter,
...
legend_labels=[
  'Planck $\\ell < 1296$ + DESY5 + DESI, QUAD SCF (MNU)', 
  'Planck $\\ell < 1296$ + DESY5 + DESI  (no z=0.5, 0.7) + BOSS (no z=0.3), QUAD SCF (MNU)', 
],
