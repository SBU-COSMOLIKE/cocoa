...
samples.saveAsText(chaindir + '/.VM_PKIM4_TMP1')
# --------------------------------------------------------------------------------
...
samples.saveAsText(chaindir + '/.VM_PKIM4_TMP2')
# --------------------------------------------------------------------------------
...
samples.saveAsText(chaindir + '/.VM_PKIM4_TMP3')
...
param_3d = None
g.triangle_plot(['.VM_PKIM4_TMP1','.VM_PKIM4_TMP2','.VM_PKIM4_TMP3'],parameter,
